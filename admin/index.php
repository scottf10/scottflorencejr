        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success text-white mb-4">
                <div class="card-body">Total Photos
                    <?php
                        $dash_photo_query = "SELECT * from photos";
                        $dash_photo_query_run = mysqli_query($con, $dash_photo_query);
                        
                        if($photo_total = mysqli_num_rows($dash_photo_query_run))
                        {
                            echo '<h4 class="mb-0"> '.$photo_total.' </h4>';
                        }
                        else
                        {
                            echo '<h4 class="mb-0"> No Data </h4>';
